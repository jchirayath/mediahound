...
[![CodeQL](https://github.com/jchirayath/reelshelf/actions/workflows/codeql.yml/badge.svg)](https://github.com/jchirayath/reelshelf/actions/workflows/codeql.yml)
...
> Once published to PyPI you can skip the clone and just `pip install reelshelf` (then
> `reelshelf init …`). Maintainers: see [RELEASING.md](RELEASING.md) for the one-time publish setup.
